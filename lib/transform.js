...
var start = '<!-- START doctoc  TOC please keep comment here to allow auto update -->\n' +
            '<!-- DON\'T EDIT THIS SECTION, INSTEAD RE-RUN doctoc TO UPDATE -->'
  , end   = '<!-- END doctoc  TOC please keep comment here to allow auto update -->'

function matchesStart(line) {
  return (/<!-- START doctoc  TOC /).test(line);
}

function matchesEnd(line) {
  return (/<!-- END doctoc  TOC /).test(line);
}
